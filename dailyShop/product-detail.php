                  ...
                  <div class="aa-product-view-slider">                                
                    <div id="demo-1" class="simpleLens-gallery-container">
                      <div class="simpleLens-container">
                        <div class="simpleLens-big-image-container"><a data-lens-image="../admin/resources/uploads/<?php echo $data['image']; ?>" class="simpleLens-lens-image"><img src="../admin/resources/uploads/<?php echo $data['image']; ?>" class="simpleLens-big-image"></a></div>
                      </div>
                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="aa-product-view-content">
                    ...
                    <div class="aa-prod-view-bottom">
                        <button class="aa-add-to-cart-btn" onclick="addCart(<?php echo $data['id']; ?>)">Add To Cart</button>
                      <!-- <a class="aa-add-to-cart-btn" href="#" onclick="addCart(<?php echo $data['id']; ?>)">Add To Cart</a> -->
